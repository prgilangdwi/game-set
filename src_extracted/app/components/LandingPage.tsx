  ...
  const features = [
    {
      ...
      description: "Automated scheduling and pairing for perfect Americano events"
    },
    {
      icon: Users,
      title: "Mixed Doubles",
      description: "Smart team formation and rotation for balanced competition"
    },
    {
      icon: Calendar,
      title: "Round Robin",
      description: "Complete round-robin scheduling with real-time updates"
    },
    {
      icon: BarChart3,
      title: "Live Analytics",
      description: "Track performance, rankings, and statistics in real-time"
    },
    {
      icon: Zap,
      title: "Instant Updates",
      description: "Live scoreboards and standings across all devices"
    },
    {
      icon: Shield,
      title: "Tournament Management",
      description: "Complete control over your tennis events and leagues"
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-border bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button variant="ghost" onClick={onLogin} className="text-sm font-medium">Sign In</Button>
            <Button className="bg-forest-green text-white hover:bg-forest-green-light text-sm font-medium" onClick={onGetStarted}>
              Get Started
            </Button>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16 lg:py-24">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Button
              size="lg"
              className="bg-forest-green text-white hover:bg-forest-green-light font-medium px-6"
              onClick={onGetStarted}
            >
              Start Free Trial
            </Button>
            <Button size="lg" variant="outline" className="font-medium px-6 border-border">
              Watch Demo
            </Button>
          </div>
        </div>
        ...
        <div className="mt-16 relative">
          <div className="rounded-xl border border-border bg-warm-gray p-8 lg:p-12 shadow-lg">
            <div className="aspect-video bg-white rounded-lg border border-border flex items-center justify-center">
              <Trophy className="w-24 h-24 text-forest-green/20" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16 bg-warm-gray/30">
        <div className="text-center mb-12">
          <h3 className="text-3xl lg:text-4xl font-semibold mb-3 text-foreground">Everything You Need</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="border border-border bg-white p-6 hover:shadow-md transition-shadow">
      ...
      <section className="container mx-auto px-4 py-16">
        <Card className="border border-border bg-warm-gray p-12 lg:p-16 text-center">
          <h3 className="text-3xl lg:text-4xl font-semibold mb-4 text-foreground">Ready to Get Started?</h3>
